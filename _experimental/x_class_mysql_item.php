	...
	class x_class_mysql_relation {
		...
		private function create_table() {
			return $this->mysql->query("CREATE TABLE IF NOT EXISTS `".$this->tablename."` (
										  ...
										  `link` int(10) NOT NULL COMMENT 'Related Link',
		...
		// Constructor
		function __construct($mysql, $tablename, $name_one = "ref", $name_two = "link", $section = "") {
			$this->mysql	= $mysql;
		...
		public function delete($id = false) {
			$this->mysql->query("DELETE FROM `".$this->tablename."` WHERE = ".$id." AND section = '".$this->section."'");
		}		
		...
		// Resort and Auto-Increment Reset Table
